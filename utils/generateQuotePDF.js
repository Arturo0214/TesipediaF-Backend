...
import { generarEsquemaPago, formatDateForDisplay } from './esquemaPago.js';
...
export const generateQuotePDF = async (data) => {
    ...
    const quoteData = {
        ...
        esquemaPago: generarEsquemaPago(precioConDescuentoCalc, data),
    ...
    const quoteNumber = data.folio || `COT-${Date.now().toString().slice(-6)}`;
